...
# See MetaStore.downgrade_by_mtime():
VERIFY_BY_MTIME = DAY
DOWNGRADE_BY_MTIME = VERIFY_BY_MTIME * 2

# See MetaStore.purge_or_downgrade_by_store_atime():
DOWNGRADE_BY_STORE_ATIME = DAY * 7
PURGE_BY_STORE_ATIME = DOWNGRADE_BY_STORE_ATIME * 2

# See MetaStore.downgrade_by_verified():
VERIFY_BY_VERIFIED = DAY * 15
DOWNGRADE_BY_VERIFIED = VERIFY_BY_VERIFIED * 2
